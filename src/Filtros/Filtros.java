...
public class Filtros {
	...
	public static MatrizImagen filtroSuavizadoPromedioGaussiano(MatrizImagen matriz, int width, int height, int maxGray) {
	    int[][] suavizada = new int[height][width];
	...
	public static MatrizImagen aplicarFiltroSobel(MatrizImagen matriz, int width, int height, int maxGray) {
	    ...
	    // Devolver la imagen resultante con la escala adecuada (maxGray puede ser 255 o 65535)
